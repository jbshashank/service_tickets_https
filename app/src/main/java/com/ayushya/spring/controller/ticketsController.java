...
public class ticketsController
{
  ...
  public Iterable<tickets> getTicketsBasedOnVisitDate(@PathVariable String visit_date,
                                                      Pageable pageable)
  {
  ...
  public tickets updateTicket(@PathVariable String _id,
                              @Valid @RequestBody tickets ticket)
  {
    ticket.set_id(_id);
